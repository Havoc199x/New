...
<div class="notif-bell">
    ...
    <div class="main-container">
        <div class="title-container">
            <h3 style="margin-left: 18px;">Status:</h3>
            <h5 style="margin-left: 18px;">Clear <i style="font-size:24px; color: green;" class="fa">&#xf00c;</i>
            </h5>
        </div>
    </div>
    <hr style="margin-left: 400px; margin-right: 130px;">
    ...
    <div class="main-container">
        <div class="title-container">
            ...
            <h5 style="margin-left: 18px;"> No Pending Report
            </h5>
        </div>
    </div>
    <hr style="margin-left: 400px; margin-right: 130px;">
