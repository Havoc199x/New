...
<div class="notif-bell">
    ...
    <div class="main-container">
        <button class="DO-dashboard-button">
            <div class="title-container">
            <h3 style="text-align: center;">Messages
            </h3>
            <h5>0 Report to review
            </h5>
        </div>
        </button>
        ...
        <div class="title-container">
            ...
            <h5>No Schedule Today
            </h5>
        </div>
        </button>

        <button class="DO-dashboard-button" onclick="redirectToDORecords()">
        <div class="title-container">
            <h3 style="text-align: center;">History
            </h3>
            <h5>Reports record
            </h5>
        </div>
    ...
    /* Redirected to Students Records */
    function redirectToDORecords() {
        window.location.href = 'http://localhost:8080/DisciplinaryOffice/DOStudentRecords.php';
    }
